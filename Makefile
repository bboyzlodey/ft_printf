NAME = libftprintf.a
LIBFTA = libft.a
SRCS = functions_que.c find_1.c find_2.c ft_integers.c calculate_managment.c calculate.c flag_management_2.c \
...
utils.c width_management.c ft_double.c ft_double_2.c
OBJ = $(SRCS:.c=.o)
LIBDIR = libft/
