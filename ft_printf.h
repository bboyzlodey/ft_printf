...
unsigned int	float_to_unint(float f);
unsigned int	manti_calc(unsigned int tmp);
int				exp_calc(unsigned int raw);
int				sign_calc(unsigned int raw);
simple_float	*get_structure(void);
simple_float	*init_floats(float f, simple_float *toInit);
void			convert_float_str(float f);
